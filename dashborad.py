...
class SMS:
    def __init__(self,root):
        ...
        #====footer====
        lbl_footer=Label(self.root,text="SMS -Stockpile Management System | Developed By-Falguni Patil, Shivam Mane, Ankit Pandey\nFor Any Technical Issue Contact-9987224430",font=("times new roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
