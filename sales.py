...
class salesClass:
    def __init__(self,root):
        ...
        txt_invoice=Entry(self.root,textvariable=self.var_invoice,font=("times new roman",15),bg="lightyellow").place(x=160,y=100,width=120,height=28) 
    ...
    def search(self):
        if self.var_invoice.get()=="":
            ...
            if self.var_invoice.get() in self.bill_list:
                ...
                messagebox.showerror("Error"," InvalidInvoice no. ",parent=self.root)
